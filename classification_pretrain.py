...
class Network(nn.Module):
    def __init__(self, _num_layers, _conv_parameters, _activation_funct, _model_resnet, *args, **kwargs):
        ...
        avg_layers = nn.Linear(input_layer.out_features, self.num_filter)
        output_layer = nn.Linear(self.num_filter, self.num_filter)
